...
use rs_matter::data_model::networks::{
    NetChangeNotif, NetCtlConnect, WirelessMgr, WirelessNetwork, WirelessNetworks,
};
    ...
    E: Embedding + 'static,
{
        ...
        N: NetCtl,
    {
        ...
        let mut oper_net_act_task = pin!(async {
            loop {
                if btp.conn_ct() == 0 && net_ctl.network_id(|id| !id.is_empty()) {
                    break;
                }
